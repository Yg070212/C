...
#pragma region Unique 포인터
	...
	// unique_ptr<Packet> uniquePointer1 = make_unique<Packet>(); // (new int); 로도 출력 가능.
	// 
	// cout << "uniquePount1의 Data 값 : " << uniquePointer1->Data() << endl;
	// 
	// unique_ptr<Packet> uniquePointer2 = std::move(uniquePointer1);
	// 
	// cout << "uniquePount1의 Data 값 : " << uniquePointer1->Data() << endl;
	// cout << "uniquePount2의 Data 값 : " << uniquePointer2->Data() << endl;
...
#pragma region Shared 포인터
	// 하나의 자원 객체를 여러 포인트 객체가 가리킬 수 있으며,
	...
	// 
	// cout << "sharedPointer1의 참조 횟수 : " << sharedPointer1.use_count() << endl;
	// cout << "sharedPointer2의 참조 횟수 : " << sharedPointer1.use_count() << endl;
#pragma endregion
